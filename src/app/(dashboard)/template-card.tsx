...
const TemplateCard = ({
    ...
    return ( 
        <button 
            ...
            disabled={disabled}
            className={
                cn("space-y-2 group text-left transition flex flex-col",
        ...
        >
            <div 
                ...
                className="relative rounded-xl aspect-[3/2] h-full w-full 
                ...
                {isPro && (
                    <div className="absolute top-2 right-2 h-10 w-10 flex items-center 
                                    justify-center bg-black/50 rounded-full z-[10]">
